...
best_prec1 = 0
tprec1_thresholds = {'resnet50': 68.75,
                     'densenet121': 66.375,
                     'mobilenet_v3_large': 60.625}

def main(my_args):
    global args, best_prec1
    args = my_args

    args.tprec1 = tprec1_thresholds[args.arch]
    print(f"=> using prec1 threshold of {args.tprec1}")
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.tprec1 <= prec1:
            print(f'Achieved target prec1 of {args.tprec1}, early stopping!')
            break
