...
class T5PreTrainedModel(PreTrainedModel):
    ...
    def _init_weights(self, module):
        ...
        elif isinstance(module, (T5Model, T5EncoderModel, T5ForConditionalGeneration)):
...
#mgit
@torch.fx.wrap
def invert_attention_mask_helper(self, encoder_attention_mask: torch.Tensor) -> torch.Tensor:
...
class T5Stack(T5PreTrainedModel):
    ...
    # mgit
    def invert_attention_mask(self, x):
        return invert_attention_mask_helper(self, x)
